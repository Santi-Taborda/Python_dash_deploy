...
register_page(__name__, name="SAT_PUEBLO_RICO_40D", path='/SAT/PUEBLO_RICO/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT PUEBLO RICO 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[5.2222, -76.0304], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_PuebloRico_40D")
...
@callback(
    Output("layer_SAT_PuebloRico_40D", "children"),
    [Input("layer_SAT_PuebloRico_40D", "id"),
