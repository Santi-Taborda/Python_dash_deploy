...
@callback(
    Output("layer_SATMA", "children"),
    [Input("layer_SATMA", "id"),
...
def update_map(_, n):
    ...
    for index, figure_name in enumerate(cant_figures):
        estacion=estaciones[estaciones['Estacion']==figure_name]
