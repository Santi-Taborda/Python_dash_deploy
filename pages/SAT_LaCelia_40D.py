...
register_page(__name__, name="SAT_LA_CELIA_40D", path='/SAT/LA_CELIA/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT LA CELIA 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[5.0035, -76.0032], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_LaCelia_40D")
...
@callback(
    Output("layer_SAT_LaCelia_40D", "children"),
    [Input("layer_SAT_LaCelia_40D", "id"),
