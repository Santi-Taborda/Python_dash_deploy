...
register_page(__name__, name="SAT_MISTRATO_40D", path='/SAT/MISTRATO/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT MISTRATÓ 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[5.2991, -75.8828], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_Mistrato_40D")
...
@callback(
    Output("layer_SAT_Mistrato_40D", "children"),
    [Input("layer_SAT_Mistrato_40D", "id"),
