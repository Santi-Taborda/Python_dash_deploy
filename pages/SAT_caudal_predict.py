...
register_page(__name__, name="Predicción de caudales SAT Risaralda", path='/SAT/caudal_predict')


layout = dbc.Container(children=[
    html.Div(
        children=[
            html.H1("Predicción caudales SAT Risaralda", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left': '20px', 'padding': '10px'}),
            html.Hr()
        ],
    ...
    dbc.Row(children=[
        ...
        dbc.Col( id='dates_SAT_caudal_predict',
            children=[
...
@callback(
    [Output('monitor_oferta_caudal_predict_SAT', 'figure'),
     Output('dates_SAT_caudal_predict', 'children')],
