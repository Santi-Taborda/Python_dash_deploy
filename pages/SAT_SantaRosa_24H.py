...
register_page(__name__, name="SAT_SANTA_ROSA_24H", path='/SAT/SANTA_ROSA/24H')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT SANTA ROSA 24 HORAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[4.8837, -75.6268], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_SantaRosa_24H")
...
@callback(
    Output("layer_SAT_SantaRosa_24H", "children"),
    [Input("layer_SAT_SantaRosa_24H", "id"),
