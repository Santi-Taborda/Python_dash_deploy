...
register_page(__name__, name="SAT_PEREIRA_24H", path='/SAT/PEREIRA/24H')
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[4.8074, -75.7345], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_Pereira_24H")
...
@callback(
    Output("layer_SAT_Pereira_24H", "children"),
    [Input("layer_SAT_Pereira_24H", "id"),
