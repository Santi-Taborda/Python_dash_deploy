...
register_page(__name__, name="SAT_LA_VIRGINIA_40D", path='/SAT/LA_VIRGINIA/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT LA VIRGINIA 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    style={'background-color':'AliceBlue'},
    ),
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[4.9005, -75.8818], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_LaVirginia_40D")
...
@callback(
    Output("layer_SAT_LaVirginia_40D", "children"),
    [Input("layer_SAT_LaVirginia_40D", "id"),
