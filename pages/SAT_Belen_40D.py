...
register_page(__name__, name="SAT_BELEN_40D", path='/SAT/BELEN/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT BELÉN DE UMBRÍA 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[5.2021, -75.8677], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_Belen_40D")
...
@callback(
    Output("layer_SAT_Belen_40D", "children"),
    [Input("layer_SAT_Belen_40D", "id"),
