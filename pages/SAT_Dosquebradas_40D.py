...
register_page(__name__, name="SAT_DOSQUEBRADAS_40D", path='/SAT/DOSQUEBRADAS/40D')

layout= dbc.Container(children=[
    html.Div(
        children=[
    html.H1("Monitor SAT DOSQUEBRADAS 40 DÍAS", style={'textAlign': 'left', 'color': '#0d6efd', 'margin-left':'20px', 'padding':'10px'}),
    html.Hr()],
    ...
    dbc.Row(children=[
        dbc.Col([
            dl.Map(center=[4.8320, -75.6775], zoom=12, children=[
                dl.TileLayer(),
                dl.LayerGroup(id="layer_SAT_Dosquebradas_40D")
...
@callback(
    Output("layer_SAT_Dosquebradas_40D", "children"),
    [Input("layer_SAT_Dosquebradas_40D", "id"),
