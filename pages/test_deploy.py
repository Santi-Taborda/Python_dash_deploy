...
# Conexión a la base de datos MySQL
    ...
    # Consultas SQL
    query1 = "SELECT idEstacion, idVariable, IdTiempoRegistro, Valor FROM factmonitoreo WHERE idEstacion IN (2, 9, 12, 21, 22, 14, 31, 26, 84, 24, 25, 79, 23, 10, 15, 8, 3, 82, 80) AND IdTiempoRegistro BETWEEN %s AND %s"
